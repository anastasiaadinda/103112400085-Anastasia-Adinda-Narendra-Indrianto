...
// =================================================================
// BAGIAN B: IMPLEMENTASI MaxNilaiAkhir()
// =================================================================

void MaxNilaiAkhir(StackMahasiswa MHS) {
    if (isEmpty(MHS)) {
        cout << "\nTidak dapat mencari nilai maksimum karena Stack KOSONG." << endl;
        return;
    }
    ...
    for (int i = 0; i <= MHS.Top; i++) {
        ...
        if (nilai_akhir > max_nilai) {
            ...
            max_posisi = i + 1; // Posisi = index + 1
        }
    }

    cout << "\n HASIL BAGIAN B: NILAI AKHIR TERBESAR " << endl;
    cout << "Nilai Akhir Terbesar: " << fixed << setprecision(1) << max_nilai << endl;
    cout << "Ditemukan pada Posisi ke-" << max_posisi << endl;
    cout << "Nama Mahasiswa: " << MHS.dataMahasiswa[max_posisi - 1].Nama 
         << " (NIM: " << MHS.dataMahasiswa[max_posisi - 1].NIM << ")" << endl;
    cout << endl;
}